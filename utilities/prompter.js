...
// Endpoints:
prompter.put('/promptx1', async (req, res) => {
...
prompter.put('/promptx2/header', async (req, res) => {
...
prompter.put('/promptx2/noheader', async (req, res) => {
    let message = "You are given a portion of a '" + req.body.header + "' notes document with messages attached to ID numbers. " +
...
prompter.put('/promptx3/bullet', async (req, res) => {
    let message = "You are given a portion of a '" + req.body.header + "' notes document with messages attached to ID numbers. " +
